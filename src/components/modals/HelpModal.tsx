        ...
        <div className="flex-1 overflow-y-auto square-scrollbar pr-1.5 sm:pr-2 flex flex-col gap-2.5 sm:gap-3 text-xs font-sans text-foreground/90 select-text leading-relaxed">
          ...
          <div className="rounded-[2px] border border-border/70 bg-card/25 overflow-hidden shrink-0 transition-all">
            <button
              ...
              aria-expanded={openSections.saving}
              className="w-full px-3 py-2.5 sm:px-4 sm:py-3 flex items-center justify-between hover:bg-muted/30 transition-colors cursor-pointer select-none text-left"
            >
              <div className="flex items-center gap-2 text-primary font-semibold text-xs tracking-wider uppercase">
                <HardDrive className="w-3.5 h-3.5 shrink-0" />
                <h3 className="font-semibold text-xs tracking-wider uppercase">Saving, Import & Export</h3>
              </div>
              <ChevronDown
                className={`w-3.5 h-3.5 text-muted-foreground transition-transform duration-200 ${
                  openSections.saving ? 'rotate-180' : ''
                }`}
              />
            </button>
            {openSections.saving && (
          ...
          <div className="rounded-[2px] border border-border/70 bg-card/25 overflow-hidden shrink-0 transition-all">
            ...
            >
              <div className="flex items-center gap-2 text-primary font-semibold text-xs tracking-wider uppercase">
                ...
                <h3 className="font-semibold text-xs tracking-wider uppercase">Settings Reference</h3>
              </div>
              <ChevronDown
                className={`w-3.5 h-3.5 text-muted-foreground transition-transform duration-200 ${
          ...
          <div className="rounded-[2px] border border-border/70 bg-card/25 overflow-hidden shrink-0 transition-all">
            ...
            >
              <div className="flex items-center gap-2 text-primary font-semibold text-xs tracking-wider uppercase">
                ...
                <h3 className="font-semibold text-xs tracking-wider uppercase">Keyboard Shortcuts</h3>
              </div>
              <ChevronDown
                className={`w-3.5 h-3.5 text-muted-foreground transition-transform duration-200 ${
                  openSections.shortcuts ? 'rotate-180' : ''
                }`}
              />
            </button>
